!(function () {
	 ...
	 */ var d,
		...
		It = function (t, e, i) {
			...
			if ((n && (o.duration = t[1]), (o.parent = i), e)) {
				for (r = o; i && !("immediateRender" in r); )
					(r = i.vars.defaults || {}), (i = et(i.vars.inherit) && i.parent);
		...
		ee = function (t, e) {
			...
			if (
				((e._time || (e._initted && !e._dur)) &&
					((i = Jt(t.rawTime(), e)),
					(!e._dur || ce(0, e.totalDuration(), i) - e._tTime > j) &&
						e.render(i, !0)),
		...
		re = function (t, e) {
			return (
				(ft.ScrollTrigger || mt("scrollTrigger", e)) &&
				ft.ScrollTrigger.create(e, t)
			);
		},
		ne = function (t, e, i, r) {
			return (
		...
		oe = function (t, e, i, r) {
			...
			return (
				...
				(t._dur = s),
				(t._tDur = n ? (n < 0 ? 1e10 : Lt(s * (n + 1) + t._rDelay * n)) : s),
				o && !r ? te(t, (t._tTime = t._tDur * o)) : t.parent && Kt(t),
				i || Wt(t.parent, t),
				t
			);
		},
		...
		ge = function (t) {
			...
			return (
				...
				function (t, o, c) {
					...
					if (!b) {
						...
						"random" === r && me(b),
							...
							(b.v = x =
								(parseFloat(e.amount) ||
									parseFloat(e.each) *
										(w > x ? x - 1 : u ? ("y" === u ? x / w : w) : Math.max(w, x / w)) ||
									0) * ("edges" === r ? -1 : 1)),
							(b.b = x < 0 ? n - x : n),
					...
					return (
						(x = (b[t] - b.min) / b.max || 0), Lt(b.b + (i ? i(x) : x) * b.v) + b.u
					);
				}
			);
		},
					...
					n
						? Z(t)
							...
							: function (e) {
									...
									return (
										(h = !i || u <= i ? t[h] : e), r || h === e || J(e) ? h : h + de(e)
									);
							  }
						: ve(t)
				)
			...
			return le(st(t) ? !e : !0 === i ? !!(i = 0) : !r, function () {
				return st(t)
					...
					: (i = i || 1e-5) &&
							...
							Math.floor(
								Math.round((t - i / 2 + Math.random() * (e - t + 0.99 * i)) / i) * i * r
							) / r;
			});
		},
		xe = function (t, e, i) {
		...
		be = function (t) {
			for (var e, i, r, n, s = 0, o = ""; ~(e = t.indexOf("random(", s)); )
				(r = t.indexOf(")", e)),
					...
					(o +=
						t.substr(s, e - s) + we(n ? i : +i[0], n ? 0 : +i[1], +i[2] || 1e-5)),
					(s = r + 1);
				...
				if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), Ce[t]))
					...
					if (((f = d = t.match(ot)), e)) {
						...
						(o = (+f[0] % 360) / 360),
							(a = +f[1] / 100),
							(r =
								2 * (u = +f[2] / 100) - (n = u <= 0.5 ? u * (a + 1) : u + a - u * a)),
							f.length > 3 && (f[3] *= 1),
							(f[0] = Se(o + 1 / 3, r, n)),
							(f[1] = Se(o, r, n)),
							(f[2] = Se(o - 1 / 3, r, n));
		...
		ze = function (t) {
			...
			if (((Ie.lastIndex = 0), Ie.test(i)))
				return (
					(e = Re.test(i)), (t[1] = Pe(t[1], e)), (t[0] = Pe(t[0], e, Le(t[1]))), !0
				);
		},
		Fe =
			((k = Date.now),
				...
				wake: function () {
					g &&
						(!_ &&
							...
							(m = p.document || {}),
							(ft.gsap = Ti),
							(p.gsapVersions || (p.gsapVersions = [])).push(Ti.version),
							_t(pt || p.GreenSockGlobals || (!p.gsap && p) || {}),
		...
		Ue(
			...
			(B = function (t) {
				return t < q
					...
					? z * Math.pow(t - 1.5 / F, 2) + 0.75
					: t < 0.9090909090909092
					? z * (t -= 2.25 / F) * t + 0.9375
					: z * Math.pow(t - 2.625 / F, 2) + 0.984375;
			})
		),
		Ue("Expo", function (t) {
			...
			return (
				...
				(e.timeScale = function (t) {
					...
					return (
						...
						Gt(this.totalTime(ce(-this._delay, this._tDur, e), !0))
					);
				}),
				(e.paused = function (t) {
					return arguments.length
				...
				(e.startTime = function (t) {
					if (arguments.length) {
						...
						return (
							e && (e._sort || !this.parent) && ie(e, this, t - this._delay), this
						);
					}
					return this._start;
				}),
				(e.endTime = function (t) {
					return (
						this._start +
						(et(t) ? this.totalDuration() : this.duration()) / Math.abs(this._ts)
					);
				}),
	...
	var Je = (function (t) {
		...
		return (
			(i.to = function (t, e, i) {
				return (
					new ai(t, It(arguments, 0, this), he(this, J(e) ? arguments[3] : i)), this
				);
			}),
			(i.from = function (t, e, i) {
				return (
					new ai(t, It(arguments, 1, this), he(this, J(e) ? arguments[3] : i)), this
				);
			}),
			(i.fromTo = function (t, e, i, r) {
				return (
					new ai(t, It(arguments, 2, this), he(this, J(e) ? arguments[4] : r)), this
				);
			}),
			...
			(i.staggerFrom = function (t, e, i, r, n, s, o) {
				return (
					(i.runBackwards = 1),
					(Vt(i).immediateRender = et(i.immediateRender)),
			...
			(i.staggerFromTo = function (t, e, i, r, n, s, o, a) {
				return (
					(r.startAt = i),
					(Vt(r).immediateRender = et(r.immediateRender)),
			...
			(i.render = function (t, e, i) {
				...
				if (y !== this._tTime || i || w) {
					if (
						...
						if (
							((p = this._yoyo), (a = v + this._rDelay), this._repeat < -1 && t < 0)
						)
						...
						if (
							...
							if (
								((v = this._dur),
								(g = this._tDur),
								b && ((this._lock = 2), (m = x ? v : -1e-4), this.render(m, !0)),
								(this._lock = 0),
								!this._ts && !u)
							)
								return this;
							...
							if (((s = n._next), (n._act || r >= n._start) && n._ts && h !== n)) {
								...
								if (
									(n.render(
										n._ts > 0
											? (r - n._start) * n._ts
											: (n._dirty ? n.totalDuration() : n._tDur) + (r - n._start) * n._ts,
										e,
										i
									),
							...
							if (((s = n._prev), (n._act || O <= n._end) && n._ts && h !== n)) {
								...
								if (
									(n.render(
										n._ts > 0
											? (O - n._start) * n._ts
											: (n._dirty ? n.totalDuration() : n._tDur) + (O - n._start) * n._ts,
										e,
										i
									),
									r !== this._time || (!this._ts && !u))
						...
						((y === g && g >= this.totalDuration()) || (!y && m)) &&
							((c !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
								...
								e ||
									(t < 0 && !m) ||
									(!y && !m) ||
									(Te(this, y === g ? "onComplete" : "onReverseComplete", !0),
					...
					for (r = s.parent; o; )
						(e = o._prev),
							...
							(i = o._start) > a && s._sort && o._ts && !s._lock
								? ((s._lock = 1), (ie(s, o, i - o._delay, 1)._lock = 0))
								: (a = i),
							i < 0 &&
								o._ts &&
								((n -= i),
	...
	var Ke,
		...
		ei = function (t, e, i, r, n, s, o, a, u) {
			...
			if (
				...
				return isNaN(c * r)
					? (!l && !(e in t) && mt(e, r),
					  ti.call(this, t, e, c, r, d, a || H.stringFilter, u))
					: ((h = new xi(
							this._pt,
							t,
							e,
		...
		ii = function (t, e, i, r, n, s) {
			...
			if (
					...
					(o = new Ot[t]()).init(
						...
						o.rawVars
							...
							: (function (t, e, i, r, n) {
									if (
										(Z(t) && (t = ni(t, n, e, i, r)),
										!tt(t) || (t.style && t.nodeType) || st(t) || nt(t))
									)
				...
				((i._pt = a = new xi(i._pt, n, t, 0, 1, o.render, o, 0, o.priority)),
				i !== y)
			)
		...
		ri = function t(e, i) {
			...
			if (
				(z && (!A || !y) && (y = "none"),
				(e._ease = Xe(y, N.ease)),
				(e._yEase = k ? je(Xe(!0 === k ? y : k, N.ease)) : 0),
				k &&
					e._yoyo &&
					!e._repeat &&
				...
				if (
					((m = (l = L[0] ? Ct(L[0]).harness : 0) && v[l.prop]),
					(r = jt(v, wt)),
					E && E.render(-1, !0).kill(),
					w)
				)
				...
				for (e._pt = 0, b = (S && et(b)) || (b && !S), n = 0; n < L.length; n++) {
					if (
						...
						for (s in r)
							Ot[s] && (c = ii(s, r, e, _, a, I))
								? c.priority && (u = 1)
								: (p[s] = o = ei.call(e, a, s, "get", r[s], _, I, 0, v.stringFilter));
							...
							(l && l.render(t < 0 ? t : !r && u ? -1e-8 : l._dur * h, e, i)) ||
								...
								(_ !== this._tDur && _) ||
									...
									e ||
										(t < 0 && !d) ||
										(!_ && !d) ||
										(Te(this, _ === f ? "onComplete" : "onReverseComplete", !0),
						...
						!(function (t, e, i, r) {
							...
							if (
								(h &&
									...
									t._yoyo && 1 & s && (u = 1 - u),
									s !== o &&
										((a = 1 - u), t.vars.repeatRefresh && t._initted && t.invalidate())),
					...
					if (this.timeline) {
						...
						return (
							...
							this.parent &&
								...
								oe(this, (this._dur * this.timeline._tDur) / i, 0, 1),
							this
						);
					}
					var r,
	...
	var bi = {
		...
		registerEffect: function (t) {
			...
			(r || "").split(",").forEach(function (t) {
				return (
					t && !Ot[t] && !ft[t] && gt(e + " effect requires " + t + " plugin.")
				);
			}),
				(Mt[e] = function (t, e, r) {
		...
		exportRoot: function (t, e) {
			...
			var i,
				...
				n = new Je(t);
			for (
				n.smoothChildTiming = et(t.smoothChildTiming),
					f.remove(n),
					n._dp = 0,
	...
	var Di,
		...
		or = function t(e) {
			...
			if (
				(Ai.appendChild(r), r.appendChild(this), (this.style.display = "block"), e)
			)
				try {
		...
		ur = function (t) {
			...
			return (
				(e && (e.width || e.height)) || t.getBBox === or || (e = or.call(t, !0)),
				!e || e.width || e.x || e.y
					? e
					: {
							x: +ar(t, ["x", "cx", "x1"]) || 0,
				...
				e in Pi && e !== tr && (e = Ki),
					i.removeProperty
						? (("ms" !== e.substr(0, 2) && "webkit" !== e.substr(0, 6)) ||
								(e = "-" + e),
						  i.removeProperty(e.replace(Fi, "-$1").toLowerCase()))
						: i.removeAttribute(e);
			}
		},
			...
			return n === l || !h || dr[n] || dr[l]
				...
				: ("px" !== l && !m && (h = t(e, i, r, "px")),
				  ...
				  (!g && "%" !== l) || (!Pi[i] && !~i.indexOf("adius"))
						...
						: ((s = u ? e.getBBox()[d ? "width" : "height"] : e[p]),
						  Lt(g ? (h / s) * _ : (h / 100) * s)));
		},
		pr = function (t, e, i, r) {
			var n;
			return (
				...
				Pi[e] && "transform" !== e
					? ((n = Tr(t, r)),
					  (n =
							"transformOrigin" !== e ? n[e] : Dr(ir(t, tr)) + " " + n.zOrigin + "px"))
		...
		_r = function (t, e, i, r) {
			if (!i || "none" === i) {
				...
				s && s !== i
					? ((e = n), (i = s))
					: "borderColor" === e && (i = ir(t, "borderTopColor"));
			}
			var o,
				a,
				u,
			...
			if (
				...
				(i += ""),
				"auto" === (r += "") &&
					((t.style[e] = r), (r = ir(t, e) || r), (t.style[e] = i)),
				ze((o = [i, r])),
				(r = o[1]),
				(u = (i = o[0]).match(ut) || []),
				(r.match(ut) || []).length)
				...
				for (; (a = ut.exec(r)); )
					(d = a[0]),
						...
						d !== (c = u[w++] || "") &&
							...
							_ ||
								((_ = _ || H.units[e] || m), y === r.length && ((r += _), (v.e += _))),
							m !== _ && (h = fr(t, e, c, _) || 0),
							(v._pt = {
								_next: v._pt,
								p: p || 1 === w ? p : ",",
		...
		gr = function (t, e) {
			if (e.tween && e.tween._time === e.tween._dur) {
				...
				r &&
					(lr(s, Ki),
					u && (u.svg && s.removeAttribute("transform"), Tr(s, 1), (u.uncache = 1)));
			}
		},
		vr = {
			...
			return o.svg && t.getAttribute("transform")
				...
				: (u !== yr ||
						...
						((i = t.parentNode) && t.offsetParent) ||
							((s = 1), (r = t.nextSibling), Ai.appendChild(t)),
						(u = br(t)),
						n ? (a.display = n) : lr(t, "display"),
						s &&
							(r ? i.insertBefore(t, r) : i ? i.appendChild(t) : Ai.removeChild(t))),
		...
		Mr = function (t, e, i, r, n, s) {
			...
			i
				? l !== yr &&
				  (a = _ * v - m * g) &&
				  ((u = b * (-m / a) + O * (_ / a) - (_ * w - m * y) / a),
				  (b = b * (v / a) + O * (-g / a) + (g * w - v * y) / a),
				  (O = u))
				: ((b = (o = ur(t)).x + (~x[0].indexOf("%") ? (b / 100) * o.width : b)),
				  (O = o.y + (~(x[1] || x[0]).indexOf("%") ? (O / 100) * o.height : O))),
				r || (!1 !== r && h.smooth)
					? ((y = b - c),
					  (w = O - d),
					  (h.xOffset = f + (y * _ + w * g) - y),
					  (h.yOffset = p + (y * m + w * v) - w))
				...
				s &&
					(cr(s, h, "xOrigin", c, b),
					cr(s, h, "yOrigin", d, O),
					cr(s, h, "xOffset", f, h.xOffset),
					cr(s, h, "yOffset", p, h.yOffset)),
		...
		Tr = function (t, e) {
			...
			return (
				...
				(m = Or(t, i.svg)),
				i.svg &&
					((D = !i.uncache && !e && t.getAttribute("data-svg-origin")),
					Mr(t, D || B, !!D || i.originIsAbsolute, !1 !== i.smooth, m)),
				(p = i.xOrigin || 0),
				(_ = i.yOrigin || 0),
				m !== yr &&
					((w = m[0]),
					...
					i.svg &&
						...
						(i.forceCSS = t.setAttribute("transform", "") || !xr(ir(t, Ki))),
				...
				d || f
					? ((d *= Ri),
					  ...
					  f &&
							...
							(n *= o = Math.sqrt(1 + o * o)),
							(s *= o),
							p && ((o = Math.tan(p)), (i *= o = Math.sqrt(1 + o * o)), (r *= o))),
					  (i = Lt(i)),
					  (r = Lt(r)),
					  (n = Lt(n)),
					  (s = Lt(s)))
					: ((i = _), (s = m), (r = n = 0)),
				((O && !~(l + "").indexOf("px")) || (M && !~(c + "").indexOf("px"))) &&
					((O = fr(g, "x", l, "px")), (M = fr(g, "y", c, "px"))),
				(v || y || w || x) &&
					((O = Lt(O + v - (v * i + y * n) + w)),
					(M = Lt(M + y - (v * r + y * s) + x))),
				(u || h) &&
					((o = g.getBBox()),
					(O = Lt(O + (u / 100) * o.width)),
					(M = Lt(M + (h / 100) * o.height))),
		...
		zr = function (t, e, i) {
			...
			Pi))
				(s = l[n]) !== (o = r[n]) &&
					...
					((a = de(s) !== (h = de(o)) ? fr(i, n, s, h) : parseFloat(s)),
					(u = parseFloat(o)),
					(t._pt = new xi(t._pt, r, n, a, u - a, Ni)),
					(t._pt.u = h || 0),
					t._props.push(n));
			Rr(r, l);
		};
				...
				for (c in (Ci || sr(), e))
					if ("autoRound" !== c && ((o = e[c]), !Ot[c] || !ii(c, e, i, r, t, n)))
						if (
							((h = typeof o),
							(l = vr[c]),
							"function" === h && (h = typeof (o = o.call(i, r, t, n))),
							...
							if (
								(D && c in D
									? ((s = "function" == typeof D[c] ? D[c].call(i, r, t, n) : D[c]),
									  c in H.units && !de(s) && (s += H.units[c]),
									  "=" === (s + "").charAt(1) && (s = pr(t, c)))
									: (s = pr(t, c)),
								(u = parseFloat(s)),
								(p =
									"string" === h && "=" === o.charAt(1) ? +(o.charAt(0) + "1") : 0) &&
									(o = o.substr(2)),
								(a = parseFloat(o)),
								c in Hi &&
									("autoAlpha" === c &&
										(1 === u && "hidden" === pr(t, "visibility") && a && (u = 0),
										cr(
											this,
											T,
											"visibility",
								...
								if (
									...
									if ("transformOrigin" === c) {
										(x = void 0),
											...
											g.svg
												? Mr(t, o, 0, v, 0, this)
												: ((f = parseFloat(o.split(" ")[2]) || 0) !== g.zOrigin &&
														cr(this, g, "zOrigin", g.zOrigin, f),
												  cr(this, T, c, Dr(s), Dr(o)));
										continue;
									}
									if ("svgOrigin" === c) {
										Mr(t, o, 1, v, 0, this);
							...
							if (_ || ((a || 0 === a) && (u || 0 === u) && !Bi.test(o) && c in T))
								a || (a = 0),
									(d = (s + "").substr((u + "").length)) !==
										(f = de(o) || (c in H.units ? H.units[c] : d)) &&
										(u = fr(t, c, s, f)),
									(this._pt = new xi(
										this._pt,
										_ ? g : T,
										...
										u,
										p ? p * a : a - u,
										_ || ("px" !== f && "zIndex" !== c) || !1 === e.autoRound ? Ni : Vi
									)),
									(this._pt.u = f || 0),
	...
	class jr {
		...
		render() {
			...
			for (const t in this.renderedStyles)
				this.renderedStyles[t].previous = o(
	...
	class Ur {
		...
		render() {
			...
			(this.renderedStyles.tx.current =
				0.3 * (Xr.x - (t + this.rect.left + this.rect.width / 2))),
				(this.renderedStyles.ty.current =
					0.3 * (Xr.y - (e + this.rect.top + this.rect.height / 2)));
			for (const t in this.renderedStyles)
				this.renderedStyles[t].previous = o(
					this.renderedStyles[t].previous,
					this.renderedStyles[t].current,
	...
	class Jr {
		constructor(t, e) {
			(this.DOM = { el: t }),
				...
				(this.DOM.enterActionSVGCircle = this.DOM.enterAction.querySelector(
					"circle"
				)),
				...
				(this.DOM.excerptLink = this.DOM.excerpt.querySelector(
					".item__excerpt-link"
				)),
		...
		initEvents() {
			this.DOM.enterAction.addEventListener("mouseenter", () =>
				this.onMouseEnter()
			),
				this.DOM.enterAction.addEventListener("mouseleave", () =>
					this.onMouseLeave()
				),
				this.DOM.enterAction.addEventListener("click", () => this.open()),
				this.DOM.excerptLink.addEventListener("mouseenter", () =>
					this.onMouseEnter()
				),
				this.DOM.excerptLink.addEventListener("mouseleave", () =>
					this.onMouseLeave()
				),
			...
			this.timelineHoverOut && this.timelineHoverOut.kill(),
				(this.timelineHoverIn = Nr.timeline()
					...
					.to(
						...
						{ duration: 0.8, ease: "power3", scale: 1.1 },
						"start"
					)
					.to(
						this.DOM.imgWrap,
						{ duration: 0.8, ease: "power3", scale: 0.95 },
						"start"
					)
					...
					.set(this.DOM.heading, { x: this.invert ? "20%" : "-20%" }, "start+=0.2")
					.to(
						this.DOM.itemHeadingChars,
						{
							duration: 0.7,
			...
			this.isContentOpen ||
				...
				(this.timelineHoverOut = Nr.timeline()
					...
					.to(
						...
						{ duration: 0.8, ease: "power3", x: 0, y: 0 },
						"start"
					)
					.to(
						this.DOM.enterActionSVGCircle,
		...
		open() {
			...
			this.timelineHoverOpen = Nr.timeline()
				...
				.set(this.DOM.contentElText, { opacity: 0, y: "20%" }, "start")
				.set(this.DOM.backCtrl, { scale: 0.8, opacity: 0 }, "start")
				.to(
					[Zr, this.itemsArr.filter((t) => t != this).map((t) => t.DOM.el)],
					{ duration: 0.6, ease: "power3", opacity: 0 },
					"start"
				)
				.to(
					this.DOM.enterAction,
				...
				.to(
					this.DOM.enterActionSVGCircle,
					{
						...
						scale: 2.3,
						opacity: 0,
						onComplete: () => Nr.set(this.DOM.enterAction, { x: 0, y: 0 })
					},
					"start"
				)
				.to(
				...
				.to(
					this.DOM.imgWrap,
					{ duration: 0.5, ease: "power3.inOut", scale: 0.9, opacity: 0 },
					"start"
				)
				.to(
					this.DOM.itemHeadingChars,
					{ duration: 0.3, ease: "quad.in", x: this.invert ? "103%" : "-103%" },
					"start"
				)
				.to(
					this.DOM.contentHeadingChars,
				...
				.to(
					this.DOM.contentElText,
					{ duration: 1.3, ease: "expo", y: "0%", opacity: 1, stagger: 0.03 },
					"start+=0.7"
				)
				.to(
					this.DOM.backCtrl,
					{ duration: 1.3, ease: "expo", scale: 1, opacity: 1 },
					"start+=1"
				);
		}
		close() {
			this.timelineHoverOpen && this.timelineHoverOpen.kill(),
				...
				(this.timelineHoverClose = Nr.timeline()
					...
					.to(
						this.DOM.backCtrl,
						{ duration: 0.3, ease: "quad.in", scale: 0.9, opacity: 0 },
						"start"
					)
					.set(
						this.DOM.enterActionSVGCircle,
					...
					.to(
						this.DOM.contentElText,
						{ duration: 0.5, ease: "power4.in", opacity: 0, y: "20%" },
						"start"
					)
					.to(
						this.DOM.imgWrap,
						{ duration: 0.8, ease: "power3", scale: 1, opacity: 1 },
						"start+=0.4"
					)
					.to(
						[this.DOM.excerpt, this.DOM.metaContent],
					...
					.to(
						[Zr, this.itemsArr.filter((t) => t != this).map((t) => t.DOM.el)],
						{ duration: 0.6, ease: "power3", opacity: 1 },
						"start+=0.4"
					));
		}
	}
	...
	Promise.all([
		...
		let e = [];
		[...document.querySelectorAll(".items > .item")].forEach((t) =>
			e.push(new Jr(t, e))
		),
